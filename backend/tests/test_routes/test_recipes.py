...
class TestDebugEndpoint:
    ...
    def test_debug_recipe_success(self, client, sample_recipe_url, mock_recipe_service):
        ...
        response = client.post("/debug-recipe", json={"url": str(sample_recipe_url.url)})
    ...
    def test_debug_recipe_invalid_url(self, client):
        """Test debug with invalid URL format"""
        response = client.post("/debug-recipe", json={"url": "not-a-valid-url"})
...
class TestParseRecipeEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_parse_recipe_with_ai_success(self, client, sample_recipe_url, sample_recipe, mock_ai_available):
        ...
        with patch('app.routes.recipes.enhanced_recipe_service', mock_enhanced_service):
            response = client.post("/parse-recipe", json={"url": str(sample_recipe_url.url)})
    ...
    @pytest.mark.asyncio 
    async def test_parse_recipe_ai_fallback(self, client, sample_recipe_url, sample_recipe, mock_ai_available):
    ...
    @pytest.mark.asyncio
    async def test_parse_recipe_without_ai(self, client, sample_recipe_url, sample_recipe, mock_ai_unavailable):
...
class TestCategorizeExistingRecipe:
    ...
    @pytest.mark.asyncio
    async def test_categorize_recipe_success(self, client, sample_recipe, mock_ai_available):
        ...
        with patch('app.routes.recipes.RecipeCategorizationService', return_value=mock_service):
            response = client.post("/categorize-recipe", json=sample_recipe.dict())
    ...
    def test_categorize_recipe_ai_unavailable(self, client, sample_recipe, mock_ai_unavailable):
    ...
    @pytest.mark.asyncio
    async def test_categorize_recipe_ai_failure(self, client, sample_recipe, mock_ai_available):
...
class TestSearchEndpoint:
    ...
    def test_search_with_parameters(self, client):
        ...
        response = client.get("/search?q=pasta&health=vegetarian&limit=10&offset=20")
...
class TestCategoriesEndpoint:
    ...
    def test_get_categories_with_ai(self, client, mock_ai_available):
    ...
    def test_get_categories_without_ai(self, client, mock_ai_unavailable):
    ...
    def test_get_categories_ai_error(self, client, mock_ai_available):
...
class TestDebugAICategorization:
    ...
    @pytest.mark.asyncio
    async def test_debug_ai_categorization_success(self, client, sample_recipe_url, sample_recipe, mock_ai_available):
        """Test successful AI categorization debugging"""
        
        # Mock enhanced service
        enhanced_recipe = sample_recipe.copy()
        ...
        with patch('app.routes.recipes.EnhancedRecipeService', return_value=mock_service):
            response = client.post("/debug-ai-categorization", json={"url": str(sample_recipe_url.url)})
    ...
    def test_debug_ai_categorization_unavailable(self, client, sample_recipe_url, mock_ai_unavailable):
...
class TestAIStatusEndpoint:
    ...
    def test_ai_status_available(self, client, mock_ai_available):
    ...
    def test_ai_status_unavailable(self, client, mock_ai_unavailable):
...
class TestBatchCategorization:
    ...
    def test_start_batch_categorization_success(self, client, mock_ai_available):
        ...
        response = client.post("/batch-categorize", json=request_data)
    ...
    def test_start_batch_categorization_ai_unavailable(self, client, mock_ai_unavailable):
    ...
    def test_get_batch_status_not_found(self, client):
        ...
        response = client.get("/batch-categorize/non-existent-id")
        
        assert response.status_code == 404
        assert "Task not found" in response.json()["detail"]
    
    def test_get_batch_status_success(self, client, mock_ai_available):
        """Test getting status for existing batch task"""
        
        # First start a batch task
        request_data = {"recipe_ids": [1]}
        start_response = client.post("/batch-categorize", json=request_data)
        task_id = start_response.json()["task_id"]
        
        # Then get its status
        response = client.get(f"/batch-categorize/{task_id}")
...
class TestTestAICategorization:
    ...
    @pytest.mark.asyncio
    async def test_test_ai_categorization_success(self, client, mock_ai_available):
        ...
        with patch('app.routes.recipes.RecipeCategorizationService', return_value=mock_service):
            response = client.post("/test-ai-categorization")
    ...
    def test_test_ai_categorization_unavailable(self, client, mock_ai_unavailable):
...
class TestDebugVeganDetection:
    ...
    @pytest.mark.asyncio
    async def test_debug_vegan_detection_success(self, client, sample_recipe_url, vegan_recipe, mock_ai_available):
        ...
        with patch('app.routes.recipes.RecipeService') as mock_recipe_service:
            ...
            with patch('app.routes.recipes.RecipeCategorizationService', return_value=mock_categorization_service):
                response = client.post("/debug-vegan-detection", json={"url": str(sample_recipe_url.url)})
    ...
    @pytest.mark.asyncio
    async def test_debug_vegan_detection_with_animal_products(self, client, sample_recipe_url, sample_recipe, mock_ai_available):
    ...
    def test_debug_vegan_detection_unavailable(self, client, sample_recipe_url, mock_ai_unavailable):
